...
# Save the signature image as "signature.pdf"
signature_pdf_file = "signature.pdf"
signature_image.save(signature_pdf_file, "PDF", resolution=100.0)

print("Signature PDF generated successfully.")
...
# Add the signature PDF as an attachment to the PDF
...
# Attach the signature PDF file to the annotation
annot.set_file_attachment(signature_pdf_file)
...
signature_pdf = annotation.get_file_attachment()
